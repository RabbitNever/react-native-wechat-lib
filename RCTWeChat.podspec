...
Pod::Spec.new do |s|
  ...
  React-Native(iOS/Android) functionalities include WeChat Login, Share, Favorite and Payment
   DESC
  s.author       = { "RabbitNever" => "fox@sfxh.cc" }
  s.homepage     = "https://github.com/RabbitNever/react-native-wechat-lib"
  s.license      = "MIT"
  s.platform     = :ios, "9.0"
  s.source       = { :git => "https://github.com/RabbitNever/react-native-wechat-lib.git", :tag => "master" }
